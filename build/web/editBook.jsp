                ...
                <div class="col-12">
                    <div class="tg-innerbannercontent">
                        ...
                        <ol class="tg-breadcrumb">
                            ...
                            <li class="tg-active">Edit Book</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <form action="editBook" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="categoryId" name="categoryId">
                                    <option value="${book.getCategoryId().getCategoryId()}">${book.getCategoryId().getCategoryName()}</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="rating" name="rating">
                                    <c:forEach var="i" begin="1" end="5">
                                        <option value="${i}" ${i == book.getRating() ? 'selected' : ''}>${i}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="price">Price:</label>
                                <input type="number" class="form-control" id="price" name="price" step="0.01" value="${book.getPrice()}">
                            </div>
                           <div class="form-group" id="authorsContainer">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="4" cols="50">${book.getDescription()}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="image">Image URL:</label>
                                <input type="text" class="form-control" id="image" name="image" value="${book.getImage()}">
                            </div>
                            <div class="form-group">
                                <label for="quantity_in_stock">Quantity in stock:</label>
                                <input type="number" class="form-control" id="quantity_in_stock" name="quantity_in_stock" value="${book.getQuantitySold()}">
                            </div>
